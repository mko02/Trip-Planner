...
class Trip:
    ...
    '''
    def addEvent(self, title, add_time, add_date, add_label, add_location, add_description):
        newEvent=Event(title, add_time, add_date, add_label, add_location, add_description)
